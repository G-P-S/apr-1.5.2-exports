...
#
apr_builddir=/usr/projects/G-P-S/apr/../apr-1.5.2-exports/linux-arm-ep/build-1
apr_builders=/usr/projects/G-P-S/apr/../apr-1.5.2-exports/linux-arm-ep/build-1
top_builddir=/usr/projects/G-P-S/apr/../apr-1.5.2-exports/linux-arm-ep/build-1

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.5.2

CC=/root/CHP_SDK/cross_compile/usr/bin/arm-poky-linux-gnueabi/arm-poky-linux-gnueabi-gcc
RM=rm
AWK=gawk
SHELL=/bin/bash
...
#
CFLAGS=-fPIC -pipe -funroll-loops --sysroot=/root/CHP_SDK/sysroot
CPPFLAGS=
LDFLAGS=
LIBS=
DEFS=-DHAVE_CONFIG_H
