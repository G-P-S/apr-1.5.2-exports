...
#
apr_builddir=/usr/projects/G-P-S/apr/../apr-1.5.2-exports/linux-arm-a9s-debug/build-1
apr_builders=/usr/projects/G-P-S/apr/../apr-1.5.2-exports/linux-arm-a9s-debug/build-1
top_builddir=/usr/projects/G-P-S/apr/../apr-1.5.2-exports/linux-arm-a9s-debug/build-1

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.5.2

CC=/opt/BUILD_TOOLS/arm-a9s/bin/arm-linux-gnueabihf-gcc
RM=rm
AWK=gawk
SHELL=/bin/bash
...
#
CFLAGS=-fPIC -pipe -mfpu=neon -funroll-loops -marm -march=armv7-a -mtune=cortex-a9
CPPFLAGS=
LDFLAGS=
LIBS=
DEFS=-DHAVE_CONFIG_H
